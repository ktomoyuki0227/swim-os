  ...
  return (
    <div className="w-full max-w-md">
              ...
              <div className="flex flex-col items-center gap-1">
                <div
                  className={`flex h-9 w-9 items-center justify-center rounded-full text-sm font-bold ${
                      ...
                      : "border-2 border-[#dce3ea] text-[#8d99a8]"
                  }`}
                >
                  {done ? "✓" : num}
                </div>
                <span className={`text-xs ${active ? "font-medium text-[#005F8C]" : "text-[#8d99a8]"}`}>
                  {label}
                </span>
              </div>
              {i < steps.length - 1 && (
      ...
      <div className="rounded-2xl bg-white px-8 py-10 shadow-sm text-center">
        ...
        <p className="mb-2 text-sm text-[#5c6a7a]">
        ...
        <div className="rounded-xl bg-[#f2f7fa] px-5 py-4 text-left text-sm text-[#5c6a7a] space-y-2">
        ...
        <div className="mt-8 border-t pt-6 text-sm text-[#5c6a7a]">
          すでに確認済みの方は
