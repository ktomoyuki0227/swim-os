    ...
    <div className="space-y-6">
      ...
      <div>
        <div className="flex items-center justify-between">
          ...
          {isAdmin && session.session_status !== "cancelled" && (
            <Link
              ...
              className="flex h-8 items-center gap-1.5 rounded-full border border-[#dce3ea] bg-white px-3 text-xs font-medium text-[#005F8C] shadow-sm transition-colors hover:border-[#005F8C] hover:bg-[#e8f2f8]"
            >
        ...
        <div className="mt-2 flex items-start justify-between gap-2">
          ...
          <Badge className={`${status.className} shrink-0 mt-0.5`}>
            {status.label}
          </Badge>
        </div>
      </div>
