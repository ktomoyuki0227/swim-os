                  ...
                  return (
                    <Card key={session.id as string} className="border-[#dce3ea] opacity-70 transition-all hover:opacity-100">
                      <CardContent className="flex items-center justify-between p-3">
                        <Link href={`/instructor/sessions/${session.id}`} className="min-w-0 flex-1">
                        ...
                        <div className="ml-3 flex shrink-0 items-center gap-2">
                          ...
                          <Link
                            href={`/instructor/sessions/new?copy=${session.id as string}&team=${session.team_id as string}`}
